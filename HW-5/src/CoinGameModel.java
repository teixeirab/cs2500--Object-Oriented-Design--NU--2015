/**
 * An interface for playing a coin game. The rules of a particular coin
 * game will be implemented by
...
public interface CoinGameModel {
   ...
   * IllegalMoveException} class. Nesting a class within an
   * interface is a way to strongly associate
