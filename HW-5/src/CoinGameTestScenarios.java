...
public final class CoinGameTestScenarios {
  public static String scenario1(String board) {
    ...
    CoinGameModel model = new StrictCoinGameModel(board);

    model.addPlayer(0,"Bob");
    model.addPlayer(1,"Sam");
