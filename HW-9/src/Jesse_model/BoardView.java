 ...
 * model directly, the {@link #draw(Jesse_model.ReadOnlyBoardViewModel)} method takes a
 * {@link Jesse_model.ReadOnlyBoardViewModel}, which provides just the information that
 * this view needs.
 */
public final class BoardView {
   ...
   * @throws java.io.IOException if there's an error writing to the output channel.
   */
